...
<div>
  ...
  <ul>
    ...
    <li><strong>Servers:</strong>Web server creation (Apache) and DNS server creation (BIND9).</li>
...
<div>
  ...
  <ul>
    ...
    <li>LinkedIn: </li>
    <a href="https://www.linkedin.com/in/sergio-marcen-tomas/" target="_blank">Sergio Marcen Tomás</a>
  </ul>
</div>
